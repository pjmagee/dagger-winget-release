...
import (
	"context"
	"dagger/dagger-winget-release/internal/dagger"
	"encoding/json"
	"fmt"
	"strings"
)

type DaggerWingetRelease struct {
}
...
func (m *DaggerWingetRelease) GetLatestRelease() (string, error) {
...
func (m *DaggerWingetRelease) CreateWingetCommand(
